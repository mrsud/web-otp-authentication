		...
		<div class="container p-3 my-3 border">
			<div class="row">
				<div  class="col-6 border border-success p-4 ml-2">
					...
					<h1 class="text-success text-center">OTP VERIFICATION</h1>
			<form method="post">
			...
			$(document).ready(function(){
				...
				function send_otp(mob){
						...
						var ch = "send_otp";
							...
							url: "otp_process.php",//second file 
							method: "post",
							data: {mob:mob,ch:ch},//function pass
							dataType: "text",
							success: function(data){
								...
								if (data == 'success') {
									...
									$('#verifyotp').css("display","block");
										...
										timer(); //function for time for limit time
									$('.otp_msg').html('<div class="alert alert-success">OTP sent successfully</div>').fadeIn();// fadein use for send successfully
										
										window.setTimeout(function(){
										$('.otp_msg').fadeOut();
									},1000)//timing for 1second
